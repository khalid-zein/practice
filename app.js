document.addEventListener("DOMContentLoaded", () => {
    ...
    const moviesListContainer = document.querySelector("#moviesTitle");
    const movieDetailsContainer = document.querySelector(".details");
  
    // getting films data
    fetch("https://khalid-zein.github.io/practice/db.json")
      .then((res) => res.json())
      .then((data) => {
    ...
    function displayMovieDetails(movie) {
      const markUp = `<img src="${movie.poster}" alt="" id = "poster">
    <div>
